...
void Panorama::loadXML(const char *xml) {
    ...
    int found = sscanf(strstr(xml, "<data_properties"),
            "<data_properties image_width=\"%d\" image_height=\"%d\" tile_width=\"%d\" tile_height=\"%d\" image_date=\"%*[0-9-]\" pano_id=\"%[_-A-Za-z0-9]\" num_zoom_levels=\"%d\" lat=\"%f\" lng=\"%f\" original_lat=\"%f\" original_lng=\"%f\">",
